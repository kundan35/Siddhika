    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Spacer(modifier = Modifier.height(4.dp))
                Text(
                    text = prayer.content.take(100) + if (prayer.content.length > 100) "..." else "",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                    maxLines = 2
                )
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text = prayer.category.replaceFirstChar { it.uppercase() },
                    style = MaterialTheme.typography.labelSmall,
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                if (reminder.daysOfWeek.isNotEmpty()) {
                    Spacer(modifier = Modifier.height(4.dp))
                    Text(
                        text = reminder.daysOfWeek.joinToString(", ") {
    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text = "${scripture.totalChapters} chapter${if (scripture.totalChapters > 1) "s" else ""}",
                    style = MaterialTheme.typography.labelSmall,
